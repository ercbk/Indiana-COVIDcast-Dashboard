...
data_dict_tbl <- tibble(
      ...
      data_url = c(
            "https://raw.githack.com/ercbk/Indiana-COVIDcast-Dashboard/master/data-dictionary.html#Historical_Weekly_Positivity_Rates_and_Daily Cases_per_100,000_residents"
      )
) %>% 
