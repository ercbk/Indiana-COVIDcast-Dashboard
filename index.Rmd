...
# react_data_dates <- readr::read_rds(glue("{rprojroot::find_rstudio_root_file()}/data/dash-case-pos-dates.rds"))
# 
# lld_data_date <- ci_clean_db %>% 
#    slice(n()) %>% 
#    pull(time_value)
```
         ...
         dui_sparkline(
            ...
            components = list(
               ...
               dui_sparklineseries(
                  ...
                  fillOpacity = htmlwidgets::JS("(d, i) => (i === 17 ? 1 : 0.5)")
               ),
